...
// #include "tensorflow/lite/micro/tools/make/downloads/person_model_int8/images/192x192/meninshower_image_data_192.h"
...
void loop() {
  ...
  GetQuantizedImage(input->data.int8, (void *) meninshower_data, kMaxImageSize, -128, 1.0f);
